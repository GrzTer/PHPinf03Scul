...
$query2 = mysqli_query($connect, "SELECT DISTINCT s.data_ur, s.miot, r.rasa FROM swinki s JOIN rasy r ON s.rasy_id = r.id WHERE s.rasy_id = 1;");
$query3 = mysqli_query($connect, "SELECT imie, cena, opis FROM swinki WHERE swinki.rasy_id = 1;");
?>
